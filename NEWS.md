...
-   changes from `db_name` to `dbname` consistantly
    ([8e88e56](https://git.uk-erlangen.de/mik-diz/mik-diz-tea/r-packages/dizutils/tree/8e88e563954e9fc12ded0f61bfb8d0989af2ffef))
...
Full set of changes:
[`v0.1.2...8e88e56`](https://git.uk-erlangen.de/mik-diz/mik-diz-tea/r-packages/dizutils/compare/v0.1.2...8e88e56)
...
Full set of changes:
[`v0.0.4...v0.0.6`](https://git.uk-erlangen.de/mik-diz/mik-diz-tea/r-packages/dizutils/compare/v0.0.4...v0.0.6)
